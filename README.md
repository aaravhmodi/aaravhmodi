...
- 🔎 **Practice Playwright Crawler**  
  ...
  https://github.com/aaravhmodi/practiceplaywrightcrawler

- ✈️ **Flight Reacts (Computer Vision Meme Project)**  
  Fun computer vision experiment that detects FlightReacts-style facial expressions using OpenCV and TensorFlow, triggering meme-based reactions and overlays in real time.  
  https://github.com/aaravhmodi/flightreactscompvision

- 🏐 **LockerLink**  
  Social and messaging platform for Ontario Volleyball Association (OVA) athletes, enabling athletes, coaches, mentors, and scouts to connect through role-based profiles, community feeds, real-time 1:1 messaging, highlight challenges, and engagement-based leaderboards | Next.js, Firebase, Tailwind CSS, Cloudinary, EmailJS  
  https://github.com/aaravhmodi/lockerlink
...
- 🎓 **Math Video Search Engine**  
  ...
  https://github.com/aaravhmodi/math-video-search-engine
...
- 🎸 I co-founded a band called **Daydream** — we performed at TIFF 2023  
  Spotify: https://open.spotify.com/artist/4ZlorZ6hE7ImbKwkpkvsaY  
  TIFF: https://tiff.net/events/daydream
